...
- [05 — 4-Tier Eve Script Engine and Auto-Chain Resolver](issues/05-eve-script-engine-and-auto-chain.md) (Unblocked - Frontier)
- [06 — MySQL Schema Migration 3NF and Repository Layer](issues/06-mysql-schema-migration-and-repositories.md) (Blocked by 02)
